...
# Form implementation generated from reading ui file 'Role_window.ui'
#
...
from role_diffusion import role_txt2img
from datetime import datetime
from role_gpt import role_gpt
    ...
    def run(self):
        ...
        for i in range(row):
            if self.tableWidget.item(i, 2) is not None and self.tableWidget.item(i,
                ...
                role_txt2img(prompt, negative_prompt, scene_filename)
    ...
    def run(self):
        ...
        for i in range(row):
            if self.tableWidget.item(i, 0) is not None and self.tableWidget.item(i, 1) is not None and self.running:
                ...
                generated_prompt = role_gpt(input_prompt)
...
class Ui_Role(object):
    def setupUi(self, Role):
        ...
        Role.setPalette(palette)
        # self.centralwidget = QtWidgets.QWidget(Scene)
        # self.centralwidget.setObjectName("centralwidget")
        self.DrawListView = QtWidgets.QListView(Role)
        ...
        self.tableWidget = QtWidgets.QTableWidget(Role)
        ...
        self.widget = QtWidgets.QWidget(Role)
        ...
        self.widget1 = QtWidgets.QWidget(Role)
...
"}")
    ...
    def retranslateUi(self, Role):
        ...
        Role.setWindowTitle(_translate("Role", "MainWindow"))
        Role = "Role"
        self.ImportConfigurationButton.setText(_translate(Role, "从Excel文件导入配置"))
        self.SaveConfigurationButton.setText(_translate(Role, "保存配置到Excel文件"))
        self.SuggestKeywordsButton.setText(_translate(Role, "推导提示词"))
        self.StartDrawingButton.setText(_translate(Role, "开始绘画"))
        self.PauseButton.setText(_translate(Role, "一键暂停"))
        self.HighDefinitionButton.setText(_translate(Role, "一键高清"))
        self.ViewDrawFileButton.setText(_translate(Role, "查看文件"))
        self.label.setText(_translate(Role, "推导词进度"))
        self.label_2.setText(_translate(Role, "画图进度"))
